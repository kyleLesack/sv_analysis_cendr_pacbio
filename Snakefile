...
rule all:
	input:
		...
		expand("3_jasmine/{alignment_dir}/sniffles/specific/{strain}_dupToIns_refined_normalizeTypes_markedSpec.vcf", alignment_dir = ALIGNMENT_DIR, strain=ALL_STRAINS),
