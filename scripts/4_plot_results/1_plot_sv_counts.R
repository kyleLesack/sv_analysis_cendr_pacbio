...
sv_call_summary.df <- sv_call_summary.df %>% select(c(Strain,DEL,DUP, INV))
sv_call_summary.df
...
ggsave("1_sv_counts_grouped_strain.png", plot = p_grouped_by_strain, device = "png", path = "9_plots/sv_counts/7_ins_to_dup", scale = 1, dpi = 300, limitsize = TRUE, width = 2605, height = 1715, units = "px")
ggsave("1_sv_counts_grouped_strain_counts.png", plot = p_grouped_by_strain_counts, device = "png", path = "9_plots/sv_counts/7_ins_to_dup", scale = 1, dpi = 300, limitsize = TRUE, width = 2605, height = 1800, units = "px")
