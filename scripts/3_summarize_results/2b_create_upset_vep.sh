...
#python scripts/3_summarize_results/create_upset.py 4_vep/output/ngmlr/7_ins_to_dup/annotated_high_impact/INV-vep_per_gene-pick-no_intergenic-annotated_high_impact.vcf 1 1 --plot
...
#python scripts/3_summarize_results/create_upset.py 4_vep/output/ngmlr/7_ins_to_dup/annotated_high_impact/INV-vep_per_gene-pick-no_intergenic-annotated_high_impact.vcf 5 12 | grep "found" | sed 's/found/vep inversions/g' > 8_summary_statistics/results/ngmlr/sniffles/7_ins_to_dup/singletons/vep_high_impact/inversion_summary.txt
...
#rev 8_summary_statistics/results/ngmlr/sniffles/7_ins_to_dup/singletons/vep_high_impact/inversion_summary.txt | cut -d " " -f 1,2 | rev | tr ":" "," | tr -d " " | sort > 8_summary_statistics/results/ngmlr/sniffles/7_ins_to_dup/singletons/vep_high_impact/inversion_summary.csv
...
#sed -i '1i Strain, INV' 8_summary_statistics/results/ngmlr/sniffles/7_ins_to_dup/singletons/vep_high_impact/inversion_summary.csv
#sed -i '1i Strain, DEL-VEP' 8_summary_statistics/results/ngmlr/sniffles/7_ins_to_dup/singletons/vep_high_impact/vep_high_impact/deletion_summary.csv
#sed -i '1i Strain, DUP-VEP' 8_summary_statistics/results/ngmlr/sniffles/7_ins_to_dup/singletons/vep_high_impact/vep_high_impact/duplication_summary.csv
#sed -i '1i Strain, INV-VEP' 8_summary_statistics/results/ngmlr/sniffles/7_ins_to_dup/singletons/vep_high_impact/vep_high_impact/inversion_summary.csv
...
#csvjoin --columns=1 8_summary_statistics/results/ngmlr/sniffles/7_ins_to_dup/singletons/vep_high_impact/deletion_summary.csv 8_summary_statistics/results/ngmlr/sniffles/7_ins_to_dup/singletons/vep_high_impact/duplication_summary.csv 8_summary_statistics/results/ngmlr/sniffles/7_ins_to_dup/singletons/vep_high_impact/inversion_summary.csv > 8_summary_statistics/results/ngmlr/sniffles/7_ins_to_dup/singletons/vep_high_impact/sv_summary.csv 
